                          ...
                          <div class="row mt-3">
                            ...
                            <div class="col-3">
                              ...
                              >
                                ...
                                <option value="1">Drg. Renwi</option>
                                <option value="2">Drg. Ramadhan</option>
                                <option value="3">Drg. Hairul</option>
                              </select>
                            </div>
                          </div>
                        </div>
                              ...
                              >
                                <div class="row d-flex justify-content-center mt-4">
                                  <div class="col-8">
                                    ...
                                    <div class="card shadow-none mt-4 me-2 ms-2 border-0">
                                      <div class="card-body">
                                        <p class="text-xs">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-6 ps-0">
                                            <a
                                              class="btn btn-link btn-sm text-xs text-primary pt-0 pe-0 mb-0 font-weight-bold d-flex justify-content-end"
