      ...
      <body class="g-sidenav-show bg-gray-100">
        ...
        >
          ...
          >
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link active" href="/radiografer-data-pasien">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/radiografer-radiografi-panoramik">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/radiografer-history">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/radiografer-profil">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
